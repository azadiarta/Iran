...
import { User, Edit2, Save, X, Lock, Eye, EyeOff, CheckCircle, AlertTriangle, ChevronLeft, ChevronRight, HeartHandshake, MessageSquare } from 'lucide-react';
import { membersAPI, fundAPI, MyContribution, Paginated } from '@/lib/api';
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 mt-5">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            <h2 className="font-bold text-white flex items-center gap-2">
              <HeartHandshake className="w-4 h-4 text-white/50" />
